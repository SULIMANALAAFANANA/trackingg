...
namespace trackingg.Controllers
{
    public class IssuesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,IssueType,Priority,Created,Completed")] Issue issue)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,IssueType,Priority,Created,Completed")] Issue issue)
        {
            if (id != issue.Id)
            {
                return NotFound();
